  ...
  return (
    <div className="bd_em_part_main pb-24 pt-20 w-screen">
      <div className="text-center">
        <h1 className="font-sans font-bold text-7xl text-slate-900 mx-36">
          Start a conversation in the email world
        </h1>
        <h4 className="font-sans mx-48 text-center px-24 py-8 text-gray-500 text-xl font-normal">
        ...
        <div className="flex flex-wrap flex-row justify-center items-center pt-4 pb-16">
          <button className="bg-blue-600 py-1 px-2.5 h-14 w-44 text-white font-medium rounded">
            <a href="#">Get Started</a>
          </button>
          <button className="h-14 w-60 border rounded flex flex-row justify-center items-center  border-2 ml-4 font-semibold text-stone-700 border-slate-800 ">
